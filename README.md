...
- **POIs (7 categories, per-layer toggles)** — 73 directory-seeded entries split across restaurants (13), hotels (15), sandbars (4), landmarks (21), dive sites (10), and fishing spots (10), plus crowdsourced additions. Each category has its own layer toggle so you can show sandbars without showing every restaurant. Tap 📍 → 🍽 POI to add one anywhere on the lake (category dropdown includes all 7 types).
